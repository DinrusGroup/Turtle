...
[{_} 
[ {{10000@(113.42.0) [s0;%RU-RU [*@7;4 Класс TurtleServer]]}}&]
[s2; &]
[s1;:Upp`:`:TurtleServer`:`:class: [@(0.0.255)3 class][3 _][*3 TurtleServer][3 _:_][@(0.0.255)3 p
ublic][3 _][*@3;3 VirtualGui]&]
[s2;#%RU-RU This class implements a remote gui virtualization server 
...
[s2;%RU-RU Sets the server bind address to [%-*@3 addr]. Default is 
`"0.0.0.0`". Returns `*this for method chaining.&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Sets the host URL to [%-*@3 host]. Default URL is `"localhost`". 
Returns `*this for method chaining.&]
[s3;%RU-RU &]
[s4; &]
[s5;:Upp`:`:TurtleServer`:`:HtmlPort`(int`): [_^Upp`:`:TurtleServer^ TurtleServer][@(0.0.255) `&
]_[* HtmlPort]([@(0.0.255) int]_[*@3 port])&]
[s2;%RU-RU Sets the connection port number for serving the html file. 
...
[s2;%RU-RU Sets the connection port number for websocket connection. 
...
[s2;%RU-RU Sets a limit to the maximum number of concurrent client 
conntections. Default max. connection limit is 100. Returns `*this 
for method chaining.&]
[s3;%RU-RU &]
[s4; &]
...
[s6;%RU-RU POSIX only&]
[s2;%RU-RU If true, the server will not spawn child processes (no 
forking). Useful for debugging purposes.&]
[s3;%RU-RU &]
[ {{10000F(128)G(128)@1 [s0;%RU-RU [* Детали Конструктора]]}}&]
[s3; &]
[s5;:Upp`:`:TurtleServer`:`:TurtleServer`(`): [* TurtleServer]()&]
[s2;%RU-RU Default constructor. Initializes the server bind address 
to `"0.0.0.0`", the host URL to `"localhost`", and the connection 
port number to 8888.&]
[s3; &]
[s4; &]
...
[s2;%RU-RU Constructor overload. Initializes the host URL and the 
connection port number to provided values.&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Constructor overload. Initializes the server bind adrress, 
...
[s2;%RU-RU Starts the Turtle GUI virtualization server and runs a 
U`+`+ GUI application over it.&]
[s3;%RU-RU &]
[s0;%RU-RU ]]